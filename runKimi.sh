...
echo "========================================"
echo "Planning Benchmark — Kimi CLI Runner"
echo "========================================"
echo ""
...
if ! command -v kimi &>/dev/null; then
    ...
    echo "Please install Kimi CLI first: https://moonshotai.github.io/kimi-cli/"
    exit 1
fi
...
kimi \
    ...
    --yolo \
    --work-dir "${REPO_ROOT}" \
    --prompt "Read 1-START_HERE.md and follow its instructions."
...
kimi \
    ...
    --yolo \
    --work-dir "${REPO_ROOT}" \
    --prompt "Read 2-EVALUATE_PLAN.md and follow its instructions."
